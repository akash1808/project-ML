...
def search(dbpath, topicmappingfile, querystring, offset=0, pagesize=10):
...
#        print fields
        DocsIds= TopictoDoc(match.docid,topicmappingfile)
#        print DocsIds
...
def TopictoDoc(topicId, topicmappingfile):
...
#        print valtopicId
        ...
        if (valtopicId == str(topicId) and float(valrank) > 0.5):
#            print fields
...
search(dbpath = sys.argv[1], topicmappingfile = sys.argv[2], querystring = " ".join(sys.argv[3:]))
