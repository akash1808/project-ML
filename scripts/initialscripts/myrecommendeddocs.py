...
if len(sys.argv) < 5:
    print "Usage: %s DBPATH TOPICDATAFILEPATH MINWEIGHT QUERYTERM..." % sys.argv[0]
    sys.exit(1)

logging.basicConfig(level=logging.INFO)
recommended(dbpath = sys.argv[1], topicmappingfile = sys.argv[2], minweight = sys.argv[3], querystring = " ".join(sys.argv[4:]))
